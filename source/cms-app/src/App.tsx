...
const firebaseConfig = {
  apiKey: "AIzaSyDvOlHXMpbnPqbgYJUVkKrzsgrkcgaklSo",
  authDomain: "taxiappdev-86986.firebaseapp.com",
  projectId: "taxiappdev-86986",
  storageBucket: "taxiappdev-86986.appspot.com",
  messagingSenderId: "807039248150",
  appId: "1:807039248150:web:e6500859db72e1fd4f5237",
};
...
type Product = {
  ...
  status: string;
  published: boolean;
  related_venues: EntityReference[];
  related_products: EntityReference[];
  related_categories: EntityReference[];
  main_image: string;
  tags: string[];
  description: string;
  categories: string[];
...
const productCategoriesSchema = buildSchema<ProductCategory>({
  ...
  properties: {
    ...
    related_venues: {
      dataType: "array",
      title: "Related venues",
      description: "Reference to venues",
      of: {
        dataType: "reference",
        path: "venues"
      }
