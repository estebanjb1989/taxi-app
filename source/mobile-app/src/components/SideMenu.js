...
export default function SideMenu(props){
    ...
    //sign out 
    const logOff = () => {
        gps.location && gps.location.lat && gps.location.lng && auth.info && auth.info.profile && auth.info.profile.usertype == 'rider'? dispatch(clearTripPoints()):null;
        gps.location && gps.location.lat && gps.location.lng && auth.info && auth.info.profile && auth.info.profile.usertype == 'driver'?  StopBackgroundLocation():null;
