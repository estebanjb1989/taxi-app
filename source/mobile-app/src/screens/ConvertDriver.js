            ...
            <ScrollView style={styles.scrollViewStyle} showsVerticalScrollIndicator={false}>
                ...
                <View style={styles.form}>
                    <View style={styles.containerStyle}>
                        ...
                        {settings.bank_fields && auth.info.profile.bankName == null ? 
                        <View style={styles.textInputContainerStyle,{flexDirection: isRTL? 'row-reverse' : 'row'}}>
                            <Icon
                                name='numeric'
                                type={'material-community'}
                        ...
                        :null}
                        {settings.bank_fields && auth.info.profile.bankCode == null ? 
                        <View style={styles.textInputContainerStyle,{flexDirection: isRTL? 'row-reverse' : 'row'}}>
                            <Icon
                                name='numeric'
                                type={'material-community'}
                        ...
                        :null}
                        {settings.bank_fields && auth.info.profile.bankAccount == null ? 
                        <View style={styles.textInputContainerStyle,{flexDirection: isRTL ? 'row-reverse' : 'row'}}>
                            <Icon
                                name='numeric'
                                type={'material-community'}
