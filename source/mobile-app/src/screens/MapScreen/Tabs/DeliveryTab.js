...
import GreenPinAsset from 'assets/images/green_pin.png'
import RedPinAsset from 'assets/images/rsz_2red_pin.png'
import MicroBlackCarAsset from 'assets/images/microBlackCar.png'
        ...
        <View style={styles.container}>
                ...
                {region ?
                    tripdata.selected == 'pickup' ?
                        <View pointerEvents="none" style={styles.mapFloatingPinView}>
                            <Image pointerEvents="none" style={[styles.mapFloatingPin, { marginBottom: Platform.OS == 'ios' ? (hasNotch ? (-10 + dragging) : 33) : 40 }]} resizeMode="contain" source={GreenPinAsset} />
                        </View>
                        :
                        <View pointerEvents="none" style={styles.mapFloatingPinView}>
                            <Image pointerEvents="none" style={[styles.mapFloatingPin, { marginBottom: Platform.OS == 'ios' ? (hasNotch ? (-10 + dragging) : 33) : 40 }]} resizeMode="contain" source={RedPinAsset} />
                        </View>
                    : null}
                {tripdata.selected == 'pickup' ?
            ...
            {activeBookings && activeBookings.length >= 1 ?
                ...
                <View style={[isRTL ? styles.topTitle1 : styles.topTitle, { width: 110 }]}>
                    <Text style={{ marginHorizontal: 7, textAlign: 'center', color: '#517fa4', fontFamily: 'Roboto-Bold', fontSize: 18, }}>Delivery</Text>
                </View>
            }
                        ...
                        <ScrollView vertical={true} showsVerticalScrollIndicator={false}>
                            {allCarTypes.map((prop, key) => {
                                return (
                                    ...
                                    >
                                        <Image
                                            source={prop.image ? { uri: prop.image } : MicroBlackCarAsset}
                                            resizeMode="contain"
