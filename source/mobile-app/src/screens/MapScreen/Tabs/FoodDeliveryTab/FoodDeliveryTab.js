    ...
    return (
        <View style={styles.container}>
            ...
            {activeBookings && activeBookings.length >= 1 ?
                ...
                :
                <View style={[isRTL ? styles.topTitle1 : styles.topTitle, { width: 110, backgroundColor: colors.BACKGROUND, }]}>
                    <Text style={{ marginHorizontal: 7, textAlign: 'center', color: colors.BUTTON_ORANGE, fontFamily: 'Roboto-Bold', fontSize: 18, }}>Comidas</Text>
                </View>
            }
